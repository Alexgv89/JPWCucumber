...
const missingRunCommandUsageError = () => new UsageError("expecting command to be specified after --, e.g. allure run -- npm run test");
export class RunCommand extends Command {
    constructor() {
        ...
        this.resultsDir = Option.Array("--results-dir", {
            description: "Glob pattern or path for Allure results directories (repeatable). Overrides config.resultsDir. Quote globs in the shell",
        });
    ...
    async execute() {
        const { command, commandArgs } = parseRunCommand(this.commandToRun);
        if (!command) {
