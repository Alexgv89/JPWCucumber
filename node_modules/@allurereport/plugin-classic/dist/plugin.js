...
import { generateAllCharts, generateAttachmentsFiles, generateEnvironmentJson, generateHistoryDataPoints, generatePieChart, generateStaticFiles, generateStatistic, generateTestResults, generateTree, generateTreeByCategories, } from "./generators.js";
...
export class ClassicPlugin {
    constructor(options = {}) {
        ...
        _ClassicPlugin_generate.set(this, async (context, store) => {
            ...
            await generateAllCharts(__classPrivateFieldGet(this, _ClassicPlugin_writer, "f"), store, this.options, context);
