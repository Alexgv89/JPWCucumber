...
export declare const statisticKeys: StatisticKey[];
...
export type Allure2DurationTrendItem = Allure2TrendItem<{
    duration: number;
}>;
export type Allure2RetryTrendItem = Allure2TrendItem<{
    run: number;
    retry: number;
}>;
