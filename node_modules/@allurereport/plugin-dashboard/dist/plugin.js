...
var _DashboardPlugin_writer, _DashboardPlugin_generateAfterStart, _DashboardPlugin_generate;
...
export class DashboardPlugin {
    constructor(options = {}) {
        ...
        _DashboardPlugin_generateAfterStart.set(this, async (context, store) => {
        ...
        this.update = async (context, store) => {
            await __classPrivateFieldGet(this, _DashboardPlugin_generateAfterStart, "f").call(this, context, store);
        };
...
_DashboardPlugin_writer = new WeakMap(), _DashboardPlugin_generateAfterStart = new WeakMap(), _DashboardPlugin_generate = new WeakMap();
