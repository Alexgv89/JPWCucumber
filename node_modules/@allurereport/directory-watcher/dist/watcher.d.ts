...
export declare const findMatching: (watchDirectory: string, existingResults: Set<string>, match: (dirent: Dirent) => boolean, maximumDepth?: number, signal?: AbortSignal) => Promise<boolean>;
...
export declare const watch: (initialCallback: () => Promise<void>, iterationCallback: () => Promise<void>, doneCallback: () => Promise<void>, options?: WatchOptions) => Watcher;
