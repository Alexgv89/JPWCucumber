...
export declare const createAgentCapabilities: () => {
    ...
    readonly commands: {
        ...
        readonly run: {
            ...
            readonly options: readonly ["--config", "--cwd", "--output", "--report", "--results-dir", "--expectations", "--goal", "--task-id", "--expect-tests", "--expect-label", "--expect-env", "--expect-test", "--expect-prefix", "--expect-step-containing", "--forbid-label", "--expect-steps", "--expect-attachments", "--expect-attachment", "--environment", "--environment-name", "--silent", "--rerun-from", "--rerun-latest", "--rerun-preset", "--rerun-environment", "--rerun-label"];
        };
        readonly inspect: {
            readonly supported: true;
