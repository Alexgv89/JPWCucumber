...
const renderIndex = (params) => {
    ...
    const remainingGlobalArtifacts = globalArtifacts.filter((artifact) => !isProcessLogAttachmentName(artifact.displayName, "stdout") &&
...
const toRunManifest = (params) => {
    ...
    const stdoutArtifact = snapshot.globalArtifacts.find((artifact) => isProcessLogAttachmentName(artifact.displayName, "stdout"));
    const stderrArtifact = snapshot.globalArtifacts.find((artifact) => isProcessLogAttachmentName(artifact.displayName, "stderr"));
