...
export const sanitizeProcessCommand = (command) => {
...
export const formatProcessLogAttachmentName = (command, stream) => `${sanitizeProcessCommand(command)}.${stream}.txt`;
export const isProcessLogAttachmentName = (name, stream) => name === `${stream}.txt` || (name?.endsWith(`.${stream}.txt`) ?? false);
